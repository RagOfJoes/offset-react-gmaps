...
class Region extends React.PureComponent {
    componentDidMount() {
        const { vineyardNames } = sections[1];
        this.props.dispatch(
            changeMapCenter(
    ...
    render() {
        ...
        const { sectionTitle, appellations, vineyardNames } = sections[1];
        ...
        return (
            <div fluid className="App">
                ...
                <Map
                    ...
                    hasKmlLayer
                    kmlLayerURL="http://www.google.com/maps/d/u/0/kml?forcekml=0&mid=1Dgj_2rrvHqho_-dt2h8v-YnZ9P4g62hu&lid=xOORz84B9ik"
                    // Map Options Props
                    mapOptions={{
